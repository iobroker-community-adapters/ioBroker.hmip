...
`,"autocompletion.css",!1),i.AcePopup=oe,i.$singleLineEditor=te,i.getAriaId=H}),ace.define("ace/autocomplete/inline_screenreader",["require","exports","module"],function(A,i,D){"use strict";var f=function(){function C(y){this.editor=y,this.screenReaderDiv=document.createElement("div"),this.screenReaderDiv.classList.add("ace_screenreader-only"),this.editor.container.appendChild(this.screenReaderDiv)}return C.prototype.setScreenReaderContent=function(y){for(!this.popup&&this.editor.completer&&this.editor.completer.popup&&(this.popup=this.editor.completer.popup,this.popup.renderer.on("afterRender",function(){var u=this.popup.getRow(),c=this.popup.renderer.$textLayer,S=c.element.childNodes[u-c.config.firstRow];if(S){for(var P="doc-tooltip ",H=0;H<this._lines.length;H++)P+="ace-inline-screenreader-line-".concat(H," ");S.setAttribute("aria-describedby",P)}}.bind(this)));this.screenReaderDiv.firstChild;)this.screenReaderDiv.removeChild(this.screenReaderDiv.firstChild);this._lines=y.split(/\r\n|\r|\n/);var l=this.createCodeBlock();this.screenReaderDiv.appendChild(l)},C.prototype.destroy=function(){this.screenReaderDiv.remove()},C.prototype.createCodeBlock=function(){var y=document.createElement("pre");y.setAttribute("id","ace-inline-screenreader");for(var l=0;l<this._lines.length;l++){var u=document.createElement("code");u.setAttribute("id","ace-inline-screenreader-line-".concat(l));var c=document.createTextNode(this._lines[l]);u.appendChild(c),y.appendChild(u)}return y},C}();i.AceInlineScreenReader=f}),ace.define("ace/autocomplete/inline",["require","exports","module","ace/snippets","ace/autocomplete/inline_screenreader"],function(A,i,D){"use strict";var f=A("../snippets").snippetManager,C=A("./inline_screenreader").AceInlineScreenReader,y=function(){function l(){this.editor=null}return l.prototype.show=function(u,c,S){if(S=S||"",u&&this.editor&&this.editor!==u&&(this.hide(),this.editor=null,this.inlineScreenReader=null),!u||!c)return!1;this.inlineScreenReader||(this.inlineScreenReader=new C(u));var P=c.snippet?f.getDisplayTextForSnippet(u,c.snippet):c.value;return c.hideInlinePreview||!P||!P.startsWith(S)?!1:(this.editor=u,this.inlineScreenReader.setScreenReaderContent(P),P=P.slice(S.length),P===""?u.removeGhostText():u.setGhostText(P),!0)},l.prototype.isOpen=function(){return this.editor?!!this.editor.renderer.$ghostText:!1},l.prototype.hide=function(){return this.editor?(this.editor.removeGhostText(),!0):!1},l.prototype.destroy=function(){this.hide(),this.editor=null,this.inlineScreenReader&&(this.inlineScreenReader.destroy(),this.inlineScreenReader=null)},l}();i.AceInline=y}),ace.define("ace/autocomplete/util",["require","exports","module"],function(A,i,D){"use strict";i.parForEach=function(C,y,l){var u=0,c=C.length;c===0&&l();for(var S=0;S<c;S++)y(C[S],function(P,H){u++,u===c&&l(P,H)})};var f=/[a-zA-Z_0-9\$\-\u00A2-\u2000\u2070-\uFFFF]/;i.retrievePrecedingIdentifier=function(C,y,l){l=l||f;for(var u=[],c=y-1;c>=0&&l.test(C[c]);c--)u.push(C[c]);return u.reverse().join("")},i.retrieveFollowingIdentifier=function(C,y,l){l=l||f;for(var u=[],c=y;c<C.length&&l.test(C[c]);c++)u.push(C[c]);return u},i.getCompletionPrefix=function(C){var y=C.getCursorPosition(),l=C.session.getLine(y.row),u;return C.completers.forEach(function(c){c.identifierRegexps&&c.identifierRegexps.forEach(function(S){!u&&S&&(u=this.retrievePrecedingIdentifier(l,y.column,S))}.bind(this))}.bind(this)),u||this.retrievePrecedingIdentifier(l,y.column)},i.triggerAutocomplete=function(C,l){var l=l==null?C.session.getPrecedingCharacter():l;return C.completers.some(function(u){if(u.triggerCharacters&&Array.isArray(u.triggerCharacters))return u.triggerCharacters.includes(l)})}}),ace.define("ace/autocomplete",["require","exports","module","ace/keyboard/hash_handler","ace/autocomplete/popup","ace/autocomplete/inline","ace/autocomplete/popup","ace/autocomplete/util","ace/lib/lang","ace/lib/dom","ace/snippets","ace/config","ace/lib/event","ace/lib/scroll"],function(A,i,D){"use strict";var f=A("./keyboard/hash_handler").HashHandler,C=A("./autocomplete/popup").AcePopup,y=A("./autocomplete/inline").AceInline,l=A("./autocomplete/popup").getAriaId,u=A("./autocomplete/util"),c=A("./lib/lang"),S=A("./lib/dom"),P=A("./snippets").snippetManager,H=A("./config"),Q=A("./lib/event"),R=A("./lib/scroll").preventParentScroll,J=function(d,v){v.completer&&v.completer.destroy()},te=function(){function d(){this.autoInsert=!1,this.autoSelect=!0,this.autoShown=!1,this.exactMatch=!1,this.inlineEnabled=!1,this.keyboardHandler=new f,this.keyboardHandler.bindKeys(this.commands),this.parentNode=null,this.setSelectOnHover=!1,this.hasSeen=new Set,this.showLoadingState=!1,this.stickySelectionDelay=500,this.blurListener=this.blurListener.bind(this),this.changeListener=this.changeListener.bind(this),this.mousedownListener=this.mousedownListener.bind(this),this.mousewheelListener=this.mousewheelListener.bind(this),this.onLayoutChange=this.onLayoutChange.bind(this),this.changeTimer=c.delayedCall(function(){this.updateCompletions(!0)}.bind(this)),this.tooltipTimer=c.delayedCall(this.updateDocTooltip.bind(this),50),this.popupTimer=c.delayedCall(this.$updatePopupPosition.bind(this),50),this.stickySelectionTimer=c.delayedCall(function(){this.stickySelection=!0}.bind(this),this.stickySelectionDelay),this.$firstOpenTimer=c.delayedCall(function(){var v=this.completionProvider&&this.completionProvider.initialPosition;this.autoShown||this.popup&&this.popup.isOpen||!v||this.editor.completers.length===0||(this.completions=new N(d.completionsForLoading),this.openPopup(this.editor,v.prefix,!1),this.popup.renderer.setStyle("ace_loading",!0))}.bind(this),this.stickySelectionDelay)}return Object.defineProperty(d,"completionsForLoading",{get:function(){return[{caption:H.nls("autocomplete.loading","Loading..."),value:""}]},enumerable:!1,configurable:!0}),d.prototype.$init=function(){return this.popup=new C(this.parentNode||document.body||document.documentElement),this.popup.on("click",function(v){this.insertMatch(),v.stop()}.bind(this)),this.popup.focus=this.editor.focus.bind(this.editor),this.popup.on("show",this.$onPopupShow.bind(this)),this.popup.on("hide",this.$onHidePopup.bind(this)),this.popup.on("select",this.$onPopupChange.bind(this)),Q.addListener(this.popup.container,"mouseout",this.mouseOutListener.bind(this)),this.popup.on("changeHoverMarker",this.tooltipTimer.bind(null,null)),this.popup.renderer.on("afterRender",this.$onPopupRender.bind(this)),this.popup},d.prototype.$initInline=function(){if(!(!this.inlineEnabled||this.inlineRenderer))return this.inlineRenderer=new y,this.inlineRenderer},d.prototype.getPopup=function(){return this.popup||this.$init()},d.prototype.$onHidePopup=function(){this.inlineRenderer&&this.inlineRenderer.hide(),this.hideDocTooltip(),this.stickySelectionTimer.cancel(),this.popupTimer.cancel(),this.stickySelection=!1},d.prototype.$seen=function(v){!this.hasSeen.has(v)&&v&&v.completer&&v.completer.onSeen&&typeof v.completer.onSeen=="function"&&(v.completer.onSeen(this.editor,v),this.hasSeen.add(v))},d.prototype.$onPopupChange=function(v){if(this.inlineRenderer&&this.inlineEnabled){var p=v?null:this.popup.getData(this.popup.getRow());if(this.$updateGhostText(p),this.popup.isMouseOver&&this.setSelectOnHover){this.tooltipTimer.call(null,null);return}this.popupTimer.schedule(),this.tooltipTimer.schedule()}else this.popupTimer.call(null,null),this.tooltipTimer.call(null,null)},d.prototype.$updateGhostText=function(v){var p=this.base.row,g=this.base.column,m=this.editor.getCursorPosition().column,b=this.editor.session.getLine(p).slice(g,m);this.inlineRenderer.show(this.editor,v,b)?this.$seen(v):this.inlineRenderer.hide()},d.prototype.$onPopupRender=function(){var v=this.inlineRenderer&&this.inlineEnabled;if(this.completions&&this.completions.filtered&&this.completions.filtered.length>0)for(var p=this.popup.getFirstVisibleRow();p<=this.popup.getLastVisibleRow();p++){var g=this.popup.getData(p);g&&(!v||g.hideInlinePreview)&&this.$seen(g)}},d.prototype.$onPopupShow=function(v){this.$onPopupChange(v),this.stickySelection=!1,this.stickySelectionDelay>=0&&this.stickySelectionTimer.schedule(this.stickySelectionDelay)},d.prototype.observeLayoutChanges=function(){if(!(this.$elements||!this.editor)){window.addEventListener("resize",this.onLayoutChange,{passive:!0}),window.addEventListener("wheel",this.mousewheelListener);for(var v=this.editor.container.parentNode,p=[];v;)p.push(v),v.addEventListener("scroll",this.onLayoutChange,{passive:!0}),v=v.parentNode;this.$elements=p}},d.prototype.unObserveLayoutChanges=function(){var v=this;window.removeEventListener("resize",this.onLayoutChange,{passive:!0}),window.removeEventListener("wheel",this.mousewheelListener),this.$elements&&this.$elements.forEach(function(p){p.removeEventListener("scroll",v.onLayoutChange,{passive:!0})}),this.$elements=null},d.prototype.onLayoutChange=function(){if(!this.popup.isOpen)return this.unObserveLayoutChanges();this.$updatePopupPosition(),this.updateDocTooltip()},d.prototype.$updatePopupPosition=function(){var v=this.editor,p=v.renderer,g=p.layerConfig.lineHeight,m=p.$cursorLayer.getPixelPosition(this.base,!0);m.left-=this.popup.getTextLeftOffset();var b=v.container.getBoundingClientRect();m.top+=b.top-p.layerConfig.offset,m.left+=b.left-v.renderer.scrollLeft,m.left+=p.gutterWidth;var E={top:m.top,left:m.left};p.$ghostText&&p.$ghostTextWidget&&this.base.row===p.$ghostText.position.row&&(E.top+=p.$ghostTextWidget.el.offsetHeight);var k=v.container.getBoundingClientRect().bottom-g,B=k<E.top?{top:k,left:E.left}:E;this.popup.tryShow(B,g,"bottom")||this.popup.tryShow(m,g,"top")||this.popup.show(m,g)},d.prototype.openPopup=function(v,p,g){this.$firstOpenTimer.cancel(),this.popup||this.$init(),this.inlineEnabled&&!this.inlineRenderer&&this.$initInline(),this.popup.autoSelect=this.autoSelect,this.popup.setSelectOnHover(this.setSelectOnHover);var m=this.popup.getRow(),b=this.popup.data[m];this.popup.setData(this.completions.filtered,this.completions.filterText),this.editor.textInput.setAriaOptions&&this.editor.textInput.setAriaOptions({activeDescendant:l(this.popup.getRow()),inline:this.inlineEnabled}),v.keyBinding.addKeyboardHandler(this.keyboardHandler);var E;this.stickySelection&&(E=this.popup.data.indexOf(b)),(!E||E===-1)&&(E=0),this.popup.setRow(this.autoSelect?E:-1),E===m&&b!==this.completions.filtered[E]&&this.$onPopupChange();var k=this.inlineRenderer&&this.inlineEnabled;if(E===m&&k){var B=this.popup.getData(this.popup.getRow());this.$updateGhostText(B)}g||(this.popup.setTheme(v.getTheme()),this.popup.setFontSize(v.getFontSize()),this.$updatePopupPosition(),this.tooltipNode&&this.updateDocTooltip()),this.changeTimer.cancel(),this.observeLayoutChanges()},d.prototype.detach=function(){this.editor&&(this.editor.keyBinding.removeKeyboardHandler(this.keyboardHandler),this.editor.off("changeSelection",this.changeListener),this.editor.off("blur",this.blurListener),this.editor.off("mousedown",this.mousedownListener),this.editor.off("mousewheel",this.mousewheelListener)),this.$firstOpenTimer.cancel(),this.changeTimer.cancel(),this.hideDocTooltip(),this.completionProvider&&this.completionProvider.detach(),this.popup&&this.popup.isOpen&&this.popup.hide(),this.popup&&this.popup.renderer&&this.popup.renderer.off("afterRender",this.$onPopupRender),this.base&&this.base.detach(),this.activated=!1,this.completionProvider=this.completions=this.base=null,this.unObserveLayoutChanges()},d.prototype.changeListener=function(v){var p=this.editor.selection.lead;(p.row!=this.base.row||p.column<this.base.column)&&this.detach(),this.activated?this.changeTimer.schedule():this.detach()},d.prototype.blurListener=function(v){var p=document.activeElement,g=this.editor.textInput.getElement(),m=v.relatedTarget&&this.tooltipNode&&this.tooltipNode.contains(v.relatedTarget),b=this.popup&&this.popup.container;p!=g&&p.parentNode!=b&&!m&&p!=this.tooltipNode&&v.relatedTarget!=g&&this.detach()},d.prototype.mousedownListener=function(v){this.detach()},d.prototype.mousewheelListener=function(v){this.popup&&!this.popup.isMouseOver&&this.detach()},d.prototype.mouseOutListener=function(v){this.popup.isOpen&&this.$updatePopupPosition()},d.prototype.goTo=function(v){this.popup.goTo(v)},d.prototype.insertMatch=function(v,p){if(v||(v=this.popup.getData(this.popup.getRow())),!v)return!1;if(v.value==="")return this.detach();var g=this.completions,m=this.getCompletionProvider().insertMatch(this.editor,v,g.filterText,p);return this.completions==g&&this.detach(),m},d.prototype.showPopup=function(v,p){this.editor&&this.detach(),this.activated=!0,this.editor=v,v.completer!=this&&(v.completer&&v.completer.detach(),v.completer=this),v.on("changeSelection",this.changeListener),v.on("blur",this.blurListener),v.on("mousedown",this.mousedownListener),v.on("mousewheel",this.mousewheelListener),this.updateCompletions(!1,p)},d.prototype.getCompletionProvider=function(v){return this.completionProvider||(this.completionProvider=new oe(v)),this.completionProvider},d.prototype.gatherCompletions=function(v,p){return this.getCompletionProvider().gatherCompletions(v,p)},d.prototype.updateCompletions=function(v,p){if(v&&this.base&&this.completions){var m=this.editor.getCursorPosition(),b=this.editor.session.getTextRange({start:this.base,end:m});if(b==this.completions.filterText)return;if(this.completions.setFilter(b),!this.completions.filtered.length)return this.detach();if(this.completions.filtered.length==1&&this.completions.filtered[0].value==b&&!this.completions.filtered[0].snippet)return this.detach();this.openPopup(this.editor,b,v);return}if(p&&p.matches){var m=this.editor.getSelectionRange().start;return this.base=this.editor.session.doc.createAnchor(m.row,m.column),this.base.$insertRight=!0,this.completions=new N(p.matches),this.getCompletionProvider().completions=this.completions,this.openPopup(this.editor,"",v)}var g=this.editor.getSession(),m=this.editor.getCursorPosition(),b=u.getCompletionPrefix(this.editor);this.base=g.doc.createAnchor(m.row,m.column-b.length),this.base.$insertRight=!0;var E={exactMatch:this.exactMatch,ignoreCaption:this.ignoreCaption};this.getCompletionProvider({prefix:b,pos:m}).provideCompletions(this.editor,E,function(k,B,_){var F=B.filtered,T=u.getCompletionPrefix(this.editor);if(this.$firstOpenTimer.cancel(),_){if(!F.length){var W=!this.autoShown&&this.emptyMessage;if(typeof W=="function"&&(W=this.emptyMessage(T)),W){var re=[{caption:W,value:""}];this.completions=new N(re),this.openPopup(this.editor,T,v),this.popup.renderer.setStyle("ace_loading",!1),this.popup.renderer.setStyle("ace_empty-message",!0);return}return this.detach()}if(F.length==1&&F[0].value==T&&!F[0].snippet)return this.detach();if(this.autoInsert&&!this.autoShown&&F.length==1)return this.insertMatch(F[0])}this.completions=!_&&this.showLoadingState?new N(d.completionsForLoading.concat(F),B.filterText):B,this.openPopup(this.editor,T,v),this.popup.renderer.setStyle("ace_empty-message",!1),this.popup.renderer.setStyle("ace_loading",!_)}.bind(this)),this.showLoadingState&&!this.autoShown&&(!this.popup||!this.popup.isOpen)&&this.$firstOpenTimer.delay(this.stickySelectionDelay/2)},d.prototype.cancelContextMenu=function(){this.editor.$mouseHandler.cancelContextMenu()},d.prototype.updateDocTooltip=function(){var v=this.popup,p=this.completions.filtered,g=p&&(p[v.getHoveredRow()]||p[v.getRow()]),m=null;if(!g||!this.editor||!this.popup.isOpen)return this.hideDocTooltip();for(var b=this.editor.completers.length,E=0;E<b;E++){var k=this.editor.completers[E];if(k.getDocTooltip&&g.completerId===k.id){m=k.getDocTooltip(g);break}}if(!m&&typeof g!="string"&&(m=g),typeof m=="string"&&(m={docText:m}),!m||!m.docHTML&&!m.docText)return this.hideDocTooltip();this.showDocTooltip(m)},d.prototype.showDocTooltip=function(v){this.tooltipNode||(this.tooltipNode=S.createElement("div"),this.tooltipNode.style.margin="0",this.tooltipNode.style.pointerEvents="auto",this.tooltipNode.style.overscrollBehavior="contain",this.tooltipNode.tabIndex=-1,this.tooltipNode.onblur=this.blurListener.bind(this),this.tooltipNode.onclick=this.onTooltipClick.bind(this),this.tooltipNode.id="doc-tooltip",this.tooltipNode.setAttribute("role","tooltip"),this.tooltipNode.addEventListener("wheel",R));var p=this.editor.renderer.theme;this.tooltipNode.className="ace_tooltip ace_doc-tooltip "+(p.isDark?"ace_dark ":"")+(p.cssClass||"");var g=this.tooltipNode;v.docHTML?g.innerHTML=v.docHTML:v.docText&&(g.textContent=v.docText),g.parentNode||this.popup.container.appendChild(this.tooltipNode);var m=this.popup,b=m.container.getBoundingClientRect();g.style.top=m.container.style.top,g.style.bottom=m.container.style.bottom,g.style.display="block",window.innerWidth-b.right<320?b.left<320?m.isTopdown?(g.style.top=b.bottom+"px",g.style.left=b.left+"px",g.style.right="",g.style.bottom=""):(g.style.top=m.container.offsetTop-g.offsetHeight+"px",g.style.left=b.left+"px",g.style.right="",g.style.bottom=""):(g.style.right=window.innerWidth-b.left+"px",g.style.left=""):(g.style.left=b.right+1+"px",g.style.right="")},d.prototype.hideDocTooltip=function(){if(this.tooltipTimer.cancel(),!!this.tooltipNode){var v=this.tooltipNode;!this.editor.isFocused()&&document.activeElement==v&&this.editor.focus(),this.tooltipNode=null,v.parentNode&&v.parentNode.removeChild(v)}},d.prototype.onTooltipClick=function(v){for(var p=v.target;p&&p!=this.tooltipNode;){if(p.nodeName=="A"&&p.href){p.rel="noreferrer",p.target="_blank";break}p=p.parentNode}},d.prototype.destroy=function(){if(this.detach(),this.popup){this.popup.destroy();var v=this.popup.container;v&&v.parentNode&&v.parentNode.removeChild(v)}this.editor&&this.editor.completer==this&&(this.editor.off("destroy",J),this.editor.completer=null),this.inlineRenderer=this.popup=this.editor=null},d.for=function(v){return v.completer instanceof d||(v.completer&&(v.completer.destroy(),v.completer=null),H.get("sharedPopups")?(d.$sharedInstance||(d.$sharedInstance=new d),v.completer=d.$sharedInstance):(v.completer=new d,v.once("destroy",J))),v.completer},d}();te.prototype.commands={Up:function(d){d.completer.goTo("up")},Down:function(d){d.completer.goTo("down")},"Ctrl-Up|Ctrl-Home":function(d){d.completer.goTo("start")},"Ctrl-Down|Ctrl-End":function(d){d.completer.goTo("end")},Esc:function(d){d.completer.detach()},Return:function(d){return d.completer.insertMatch()},"Shift-Return":function(d){d.completer.insertMatch(null,{deleteSuffix:!0})},Tab:function(d){var v=d.completer.insertMatch();if(v||d.tabstopManager)return v;d.completer.goTo("down")},Backspace:function(d){d.execCommand("backspace");var v=u.getCompletionPrefix(d);!v&&d.completer&&d.completer.detach()},PageUp:function(d){d.completer.popup.gotoPageUp()},PageDown:function(d){d.completer.popup.gotoPageDown()}},te.startCommand={name:"startAutocomplete",exec:function(d,v){var p=te.for(d);p.autoInsert=!1,p.autoSelect=!0,p.autoShown=!1,p.showPopup(d,v),p.cancelContextMenu()},bindKey:"Ctrl-Space|Ctrl-Shift-Space|Alt-Space"};var oe=function(){function d(v){this.initialPosition=v,this.active=!0}return d.prototype.insertByIndex=function(v,p,g){return!this.completions||!this.completions.filtered?!1:this.insertMatch(v,this.completions.filtered[p],g)},d.prototype.insertMatch=function(v,p,g){if(!p)return!1;if(v.startOperation({command:{name:"insertMatch"}}),p.completer&&p.completer.insertMatch)p.completer.insertMatch(v,p);else{if(!this.completions)return!1;var m=this.completions.filterText.length,b=0;if(p.range&&p.range.start.row===p.range.end.row&&(m-=this.initialPosition.prefix.length,m+=this.initialPosition.pos.column-p.range.start.column,b+=p.range.end.column-this.initialPosition.pos.column),m||b){var E;v.selection.getAllRanges?E=v.selection.getAllRanges():E=[v.getSelectionRange()];for(var k=0,B;B=E[k];k++)B.start.column-=m,B.end.column+=b,v.session.remove(B)}p.snippet?P.insertSnippet(v,p.snippet):this.$insertString(v,p),p.completer&&p.completer.onInsert&&typeof p.completer.onInsert=="function"&&p.completer.onInsert(v,p),p.command&&p.command==="startAutocomplete"&&v.execCommand(p.command)}return v.endOperation(),!0},d.prototype.$insertString=function(v,p){var g=p.value||p;v.execCommand("insertstring",g)},d.prototype.gatherCompletions=function(v,p){var g=v.getSession(),m=v.getCursorPosition(),b=u.getCompletionPrefix(v),E=[];this.completers=v.completers;var k=v.completers.length;return v.completers.forEach(function(B,_){B.getCompletions(v,g,m,b,function(F,T){B.hideInlinePreview&&(T=T.map(function(W){return Object.assign(W,{hideInlinePreview:B.hideInlinePreview})})),!F&&T&&(E=E.concat(T)),p(null,{prefix:u.getCompletionPrefix(v),matches:E,finished:--k===0})})}),!0},d.prototype.provideCompletions=function(v,p,g){var m=function(B){var _=B.prefix,F=B.matches;this.completions=new N(F),p.exactMatch&&(this.completions.exactMatch=!0),p.ignoreCaption&&(this.completions.ignoreCaption=!0),this.completions.setFilter(_),(B.finished||this.completions.filtered.length)&&g(null,this.completions,B.finished)}.bind(this),b=!0,E=null;if(this.gatherCompletions(v,function(B,_){if(this.active){B&&(g(B,[],!0),this.detach());var F=_.prefix;if(F.indexOf(_.prefix)===0){if(b){E=_;return}m(_)}}}.bind(this)),b=!1,E){var k=E;E=null,m(k)}},d.prototype.detach=function(){this.active=!1,this.completers&&this.completers.forEach(function(v){typeof v.cancel=="function"&&v.cancel()})},d}(),N=function(){function d(v,p){this.all=v,this.filtered=v,this.filterText=p||"",this.exactMatch=!1,this.ignoreCaption=!1}return d.prototype.setFilter=function(v){if(v.length>this.filterText&&v.lastIndexOf(this.filterText,0)===0)var p=this.filtered;else var p=this.all;this.filterText=v,p=this.filterCompletions(p,this.filterText),p=p.sort(function(m,b){return b.exactMatch-m.exactMatch||b.$score-m.$score||(m.caption||m.value).localeCompare(b.caption||b.value)});var g=null;p=p.filter(function(m){var b=m.snippet||m.caption||m.value;return b===g?!1:(g=b,!0)}),this.filtered=p},d.prototype.filterCompletions=function(v,p){var g=[],m=p.toUpperCase(),b=p.toLowerCase();e:for(var E=0,k;k=v[E];E++){var B=!this.ignoreCaption&&k.caption||k.value||k.snippet;if(B){var _=-1,F=0,T=0,W,re;if(this.exactMatch){if(p!==B.substr(0,p.length))continue e}else{var Z=B.toLowerCase().indexOf(b);if(Z>-1)T=Z;else for(var ce=0;ce<p.length;ce++){var le=B.indexOf(b[ce],_+1),V=B.indexOf(m[ce],_+1);if(W=le>=0&&(V<0||le<V)?le:V,W<0)continue e;re=W-_-1,re>0&&(_===-1&&(T+=10),T+=re,F|=1<<ce),_=W}}k.matchMask=F,k.exactMatch=T?0:1,k.$score=(k.score||0)-T,g.push(k)}}return g},d}();i.Autocomplete=te,i.CompletionProvider=oe,i.FilteredList=N}),ace.define("ace/autocomplete/text_completer",["require","exports","module","ace/range"],function(A,i,D){function f(u,c){var S=u.getTextRange(y.fromPoints({row:0,column:0},c));return S.split(l).length-1}function C(u,c){var S=f(u,c),P=u.getValue().split(l),H=Object.create(null),Q=P[S];return P.forEach(function(R,J){if(!(!R||R===Q)){var te=Math.abs(S-J),oe=P.length-te;H[R]?H[R]=Math.max(oe,H[R]):H[R]=oe}}),H}var y=A("../range").Range,l=/[^a-zA-Z_0-9\$\-\u00C0-\u1FFF\u2C00-\uD7FF\w]+/;i.getCompletions=function(u,c,S,P,H){var Q=C(c,S),R=Object.keys(Q);H(null,R.map(function(J){return{caption:J,value:J,score:Q[J],meta:"local"}}))}}),ace.define("ace/ext/language_tools",["require","exports","module","ace/snippets","ace/autocomplete","ace/config","ace/lib/lang","ace/autocomplete/util","ace/autocomplete/text_completer","ace/editor","ace/config"],function(A,i,D){"use strict";var f=A("../snippets").snippetManager,C=A("../autocomplete").Autocomplete,y=A("../config"),l=A("../lib/lang"),u=A("../autocomplete/util"),c=A("../autocomplete/text_completer"),S={getCompletions:function(m,b,E,k,B){if(b.$mode.completer)return b.$mode.completer.getCompletions(m,b,E,k,B);var _=m.session.getState(E.row),F=b.$mode.getCompletions(_,b,E,k);F=F.map(function(T){return T.completerId=S.id,T}),B(null,F)},id:"keywordCompleter"},P=function(m){var b={};return m.replace(/\${(\d+)(:(.*?))?}/g,function(E,k,B,_){return b[k]=_||""}).replace(/\$(\d+?)/g,function(E,k){return b[k]})},H={getCompletions:function(m,b,E,k,B){var _=[],F=b.getTokenAt(E.row,E.column);F&&F.type.match(/(tag-name|tag-open|tag-whitespace|attribute-name|attribute-value)\.xml$/)?_.push("html-tag"):_=f.getActiveScopes(m);var T=f.snippetMap,W=[];_.forEach(function(re){for(var Z=T[re]||[],ce=Z.length;ce--;){var le=Z[ce],V=le.name||le.tabTrigger;V&&W.push({caption:V,snippet:le.content,meta:le.tabTrigger&&!le.name?le.tabTrigger+"\u21E5 ":"snippet",completerId:H.id})}},this),B(null,W)},getDocTooltip:function(m){m.snippet&&!m.docHTML&&(m.docHTML=["<b>",l.escapeHTML(m.caption),"</b>","<hr></hr>",l.escapeHTML(P(m.snippet))].join(""))},id:"snippetCompleter"},Q=[H,c,S];i.setCompleters=function(m){Q.length=0,m&&Q.push.apply(Q,m)},i.addCompleter=function(m){Q.push(m)},i.textCompleter=c,i.keyWordCompleter=S,i.snippetCompleter=H;var R={name:"expandSnippet",exec:function(m){return f.expandWithTab(m)},bindKey:"Tab"},J=function(m,b){te(b.session.$mode)},te=function(m){typeof m=="string"&&(m=y.$modes[m]),m&&(f.files||(f.files={}),oe(m.$id,m.snippetFileId),m.modes&&m.modes.forEach(te))},oe=function(m,b){!b||!m||f.files[m]||(f.files[m]={},y.loadModule(b,function(E){E&&(f.files[m]=E,!E.snippets&&E.snippetText&&(E.snippets=f.parseSnippetFile(E.snippetText)),f.register(E.snippets||[],E.scope),E.includeScopes&&(f.snippetMap[E.scope].includeScopes=E.includeScopes,E.includeScopes.forEach(function(k){te("ace/mode/"+k)})))}))},N=function(m){var b=m.editor,E=b.completer&&b.completer.activated;if(m.command.name==="backspace")E&&!u.getCompletionPrefix(b)&&b.completer.detach();else if(m.command.name==="insertstring"&&!E){d=m;var k=m.editor.$liveAutocompletionDelay;k?v.delay(k):p(m)}},d,v=l.delayedCall(function(){p(d)},0),p=function(m){var b=m.editor,E=u.getCompletionPrefix(b),k=m.args,B=u.triggerAutocomplete(b,k);if(E&&E.length>=b.$liveAutocompletionThreshold||B){var _=C.for(b);_.autoShown=!0,_.showPopup(b)}},g=A("../editor").Editor;A("../config").defineOptions(g.prototype,"editor",{enableBasicAutocompletion:{set:function(m){m?(this.completers||(this.completers=Array.isArray(m)?m:Q),this.commands.addCommand(C.startCommand)):this.commands.removeCommand(C.startCommand)},value:!1},enableLiveAutocompletion:{set:function(m){m?(this.completers||(this.completers=Array.isArray(m)?m:Q),this.commands.on("afterExec",N)):this.commands.off("afterExec",N)},value:!1},liveAutocompletionDelay:{initialValue:0},liveAutocompletionThreshold:{initialValue:0},enableSnippets:{set:function(m){m?(this.commands.addCommand(R),this.on("changeMode",J),J(null,this)):(this.commands.removeCommand(R),this.off("changeMode",J))},value:!1}})}),function(){ace.require(["ace/ext/language_tools"],function(A){M&&(M.exports=A)})}()},7726:(M,ee,G)=>{M=G.nmd(M),ace.define("ace/mode/json_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"],function(A,i,D){"use strict";var f=A("../lib/oop"),C=A("./text_highlight_rules").TextHighlightRules,y=function(){this.$rules={start:[{token:"variable",regex:'["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]\\s*(?=:)'},{token:"string",regex:'"',next:"string"},{token:"constant.numeric",regex:"0[xX][0-9a-fA-F]+\\b"},{token:"constant.numeric",regex:"[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b"},{token:"constant.language.boolean",regex:"(?:true|false)\\b"},{token:"text",regex:"['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']"},{token:"comment",regex:"\\/\\/.*$"},{token:"comment.start",regex:"\\/\\*",next:"comment"},{token:"paren.lparen",regex:"[[({]"},{token:"paren.rparen",regex:"[\\])}]"},{token:"punctuation.operator",regex:/[,]/},{token:"text",regex:"\\s+"}],string:[{token:"constant.language.escape",regex:/\\(?:x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|["\\\/bfnrt])/},{token:"string",regex:'"|$',next:"start"},{defaultToken:"string"}],comment:[{token:"comment.end",regex:"\\*\\/",next:"start"},{defaultToken:"comment"}]}};f.inherits(y,C),i.JsonHighlightRules=y}),ace.define("ace/mode/matching_brace_outdent",["require","exports","module","ace/range"],function(A,i,D){"use strict";var f=A("../range").Range,C=function(){};(function(){this.checkOutdent=function(y,l){return/^\s+$/.test(y)?/^\s*\}/.test(l):!1},this.autoOutdent=function(y,l){var u=y.getLine(l),c=u.match(/^(\s*\})/);if(!c)return 0;var S=c[1].length,P=y.findMatchingBracket({row:l,column:S});if(!P||P.row==l)return 0;var H=this.$getIndent(y.getLine(P.row));y.replace(new f(l,0,l,S-1),H)},this.$getIndent=function(y){return y.match(/^\s*/)[0]}}).call(C.prototype),i.MatchingBraceOutdent=C}),ace.define("ace/mode/folding/cstyle",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode"],function(A,i,D){"use strict";var f=A("../../lib/oop"),C=A("../../range").Range,y=A("./fold_mode").FoldMode,l=i.FoldMode=function(u){u&&(this.foldingStartMarker=new RegExp(this.foldingStartMarker.source.replace(/\|[^|]*?$/,"|"+u.start)),this.foldingStopMarker=new RegExp(this.foldingStopMarker.source.replace(/\|[^|]*?$/,"|"+u.end)))};f.inherits(l,y),function(){this.foldingStartMarker=/([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/,this.foldingStopMarker=/^[^\[\{\(]*([\}\]\)])|^[\s\*]*(\*\/)/,this.singleLineBlockCommentRe=/^\s*(\/\*).*\*\/\s*$/,this.tripleStarBlockCommentRe=/^\s*(\/\*\*\*).*\*\/\s*$/,this.startRegionRe=/^\s*(\/\*|\/\/)#?region\b/,this._getFoldWidgetBase=this.getFoldWidget,this.getFoldWidget=function(u,c,S){var P=u.getLine(S);if(this.singleLineBlockCommentRe.test(P)&&!this.startRegionRe.test(P)&&!this.tripleStarBlockCommentRe.test(P))return"";var H=this._getFoldWidgetBase(u,c,S);return!H&&this.startRegionRe.test(P)?"start":H},this.getFoldWidgetRange=function(u,c,S,P){var H=u.getLine(S);if(this.startRegionRe.test(H))return this.getCommentRegionBlock(u,H,S);var J=H.match(this.foldingStartMarker);if(J){var Q=J.index;if(J[1])return this.openingBracketBlock(u,J[1],S,Q);var R=u.getCommentFoldRange(S,Q+J[0].length,1);return R&&!R.isMultiLine()&&(P?R=this.getSectionRange(u,S):c!="all"&&(R=null)),R}if(c!=="markbegin"){var J=H.match(this.foldingStopMarker);if(J){var Q=J.index+J[0].length;return J[1]?this.closingBracketBlock(u,J[1],S,Q):u.getCommentFoldRange(S,Q,-1)}}},this.getSectionRange=function(u,c){var S=u.getLine(c),P=S.search(/\S/),H=c,Q=S.length;c+=1;for(var R=c,J=u.getLength();++c<J;){S=u.getLine(c);var te=S.search(/\S/);if(te!==-1){if(P>te)break;var oe=this.getFoldWidgetRange(u,"all",c);if(oe){if(oe.start.row<=H)break;if(oe.isMultiLine())c=oe.end.row;else if(P==te)break}R=c}}return new C(H,Q,R,u.getLine(R).length)},this.getCommentRegionBlock=function(u,c,S){for(var P=c.search(/\s*$/),H=u.getLength(),Q=S,R=/^\s*(?:\/\*|\/\/|--)#?(end)?region\b/,J=1;++S<H;){c=u.getLine(S);var te=R.exec(c);if(te&&(te[1]?J--:J++,!J))break}var oe=S;if(oe>Q)return new C(Q,P,oe,c.length)}}.call(l.prototype)}),ace.define("ace/mode/json",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/json_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/folding/cstyle","ace/worker/worker_client"],function(A,i,D){"use strict";var f=A("../lib/oop"),C=A("./text").Mode,y=A("./json_highlight_rules").JsonHighlightRules,l=A("./matching_brace_outdent").MatchingBraceOutdent,u=A("./folding/cstyle").FoldMode,c=A("../worker/worker_client").WorkerClient,S=function(){this.HighlightRules=y,this.$outdent=new l,this.$behaviour=this.$defaultBehaviour,this.foldingRules=new u};f.inherits(S,C),function(){this.lineCommentStart="//",this.blockComment={start:"/*",end:"*/"},this.getNextLineIndent=function(P,H,Q){var R=this.$getIndent(H);if(P=="start"){var J=H.match(/^.*[\{\(\[]\s*$/);J&&(R+=Q)}return R},this.checkOutdent=function(P,H,Q){return this.$outdent.checkOutdent(H,Q)},this.autoOutdent=function(P,H,Q){this.$outdent.autoOutdent(H,Q)},this.createWorker=function(P){var H=new c(["ace"],"ace/mode/json_worker","JsonWorker");return H.attachToDocument(P.getDocument()),H.on("annotate",function(Q){P.setAnnotations(Q.data)}),H.on("terminate",function(){P.clearAnnotations()}),H},this.$id="ace/mode/json"}.call(S.prototype),i.Mode=S}),function(){ace.require(["ace/mode/json"],function(A){M&&(M.exports=A)})}()},4210:(M,ee,G)=>{M=G.nmd(M),ace.define("ace/theme/chrome-css",["require","exports","module"],function(A,i,D){D.exports=`.ace-chrome .ace_gutter {
  background: #ebebeb;
  color: #333;
  overflow : hidden;
}
...
`}),ace.define("ace/theme/clouds_midnight",["require","exports","module","ace/theme/clouds_midnight-css","ace/lib/dom"],function(A,i,D){i.isDark=!0,i.cssClass="ace-clouds-midnight",i.cssText=A("./clouds_midnight-css");var f=A("../lib/dom");f.importCssString(i.cssText,i.cssClass,!1)}),function(){ace.require(["ace/theme/clouds_midnight"],function(A){M&&(M.exports=A)})}()},1197:function(){"no use strict";(function(M){function ee(i,D){for(var f=i,C="";f;){var y=D[f];if(typeof y=="string")return y+C;if(y)return y.location.replace(/\/*$/,"/")+(C||y.main||y.name);if(y===!1)return"";var l=f.lastIndexOf("/");if(l===-1)break;C=f.substr(l)+C,f=f.slice(0,l)}return i}if(!(typeof M.window!="undefined"&&M.document)&&!(M.require&&M.define)){M.console||(M.console=function(){var i=Array.prototype.slice.call(arguments,0);postMessage({type:"log",data:i})},M.console.error=M.console.warn=M.console.log=M.console.trace=M.console),M.window=M,M.ace=M,M.onerror=function(i,D,f,C,y){postMessage({type:"error",data:{message:i,data:y&&y.data,file:D,line:f,col:C,stack:y&&y.stack}})},M.normalizeModule=function(i,D){if(D.indexOf("!")!==-1){var f=D.split("!");return M.normalizeModule(i,f[0])+"!"+M.normalizeModule(i,f[1])}if(D.charAt(0)=="."){var C=i.split("/").slice(0,-1).join("/");for(D=(C?C+"/":"")+D;D.indexOf(".")!==-1&&y!=D;){var y=D;D=D.replace(/^\.\//,"").replace(/\/\.\//,"/").replace(/[^\/]+\/\.\.\//,"")}}return D},M.require=function(i,D){if(D||(D=i,i=null),!D.charAt)throw new Error("worker.js require() accepts only (parentId, id) as arguments");D=M.normalizeModule(i,D);var f=M.require.modules[D];if(f)return f.initialized||(f.initialized=!0,f.exports=f.factory().exports),f.exports;if(!M.require.tlns)return console.log("unable to load "+D);var C=ee(D,M.require.tlns);return C.slice(-3)!=".js"&&(C+=".js"),M.require.id=D,M.require.modules[D]={},importScripts(C),M.require(i,D)},M.require.modules={},M.require.tlns={},M.define=function(i,D,f){if(arguments.length==2?(f=D,typeof i!="string"&&(D=i,i=M.require.id)):arguments.length==1&&(f=i,D=[],i=M.require.id),typeof f!="function"){M.require.modules[i]={exports:f,initialized:!0};return}D.length||(D=["require","exports","module"]);var C=function(y){return M.require(i,y)};M.require.modules[i]={exports:{},factory:function(){var y=this,l=f.apply(this,D.slice(0,f.length).map(function(u){switch(u){case"require":return C;case"exports":return y.exports;case"module":return y;default:return C(u)}}));return l&&(y.exports=l),y}}},M.define.amd={},M.require.tlns={},M.initBaseUrls=function(i){for(var D in i)this.require.tlns[D]=i[D]},M.initSender=function(){var i=M.require("ace/lib/event_emitter").EventEmitter,D=M.require("ace/lib/oop"),f=function(){};return function(){D.implement(this,i),this.callback=function(C,y){postMessage({type:"call",id:y,data:C})},this.emit=function(C,y){postMessage({type:"event",name:C,data:y})}}.call(f.prototype),new f};var G=M.main=null,A=M.sender=null;M.onmessage=function(i){var D=i.data;if(D.event&&A)A._signal(D.event,D.data);else if(D.command)if(G[D.command])G[D.command].apply(G,D.args);else{if(!M[D.command])throw new Error("Unknown command:"+D.command);M[D.command].apply(M,D.args)}else if(D.init){M.initBaseUrls(D.tlns),A=M.sender=M.initSender();var f=this.require(D.module)[D.classname];G=M.main=new f(A)}}}})(this),ace.define("ace/lib/oop",[],function(M,ee,G){"use strict";ee.inherits=function(A,i){A.super_=i,A.prototype=Object.create(i.prototype,{constructor:{value:A,enumerable:!1,writable:!0,configurable:!0}})},ee.mixin=function(A,i){for(var D in i)A[D]=i[D];return A},ee.implement=function(A,i){ee.mixin(A,i)}}),ace.define("ace/apply_delta",[],function(M,ee,G){"use strict";function A(f,C){throw console.log("Invalid Delta:",f),"Invalid Delta: "+C}function i(f,C){return C.row>=0&&C.row<f.length&&C.column>=0&&C.column<=f[C.row].length}function D(f,C){C.action!="insert"&&C.action!="remove"&&A(C,"delta.action must be 'insert' or 'remove'"),C.lines instanceof Array||A(C,"delta.lines must be an Array"),(!C.start||!C.end)&&A(C,"delta.start/end must be an present");var y=C.start;i(f,C.start)||A(C,"delta.start must be contained in document");var l=C.end;C.action=="remove"&&!i(f,l)&&A(C,"delta.end must contained in document for 'remove' actions");var u=l.row-y.row,c=l.column-(u==0?y.column:0);(u!=C.lines.length-1||C.lines[u].length!=c)&&A(C,"delta.range must match delta lines")}ee.applyDelta=function(f,C,y){var l=C.start.row,u=C.start.column,c=f[l]||"";switch(C.action){case"insert":var S=C.lines;if(S.length===1)f[l]=c.substring(0,u)+C.lines[0]+c.substring(u);else{var P=[l,1].concat(C.lines);f.splice.apply(f,P),f[l]=c.substring(0,u)+f[l],f[l+C.lines.length-1]+=c.substring(u)}break;case"remove":var H=C.end.column,Q=C.end.row;l===Q?f[l]=c.substring(0,u)+c.substring(H):f.splice(l,Q-l+1,c.substring(0,u)+f[Q].substring(H))}}}),ace.define("ace/lib/event_emitter",[],function(M,ee,G){"use strict";var A={},i=function(){this.propagationStopped=!0},D=function(){this.defaultPrevented=!0};A._emit=A._dispatchEvent=function(f,C){this._eventRegistry||(this._eventRegistry={}),this._defaultHandlers||(this._defaultHandlers={});var y=this._eventRegistry[f]||[],l=this._defaultHandlers[f];if(!(!y.length&&!l)){(typeof C!="object"||!C)&&(C={}),C.type||(C.type=f),C.stopPropagation||(C.stopPropagation=i),C.preventDefault||(C.preventDefault=D),y=y.slice();for(var u=0;u<y.length&&(y[u](C,this),!C.propagationStopped);u++);if(l&&!C.defaultPrevented)return l(C,this)}},A._signal=function(f,C){var y=(this._eventRegistry||{})[f];if(y){y=y.slice();for(var l=0;l<y.length;l++)y[l](C,this)}},A.once=function(f,C){var y=this;if(this.on(f,function l(){y.off(f,l),C.apply(null,arguments)}),!C)return new Promise(function(l){C=l})},A.setDefaultHandler=function(f,C){var y=this._defaultHandlers;if(y||(y=this._defaultHandlers={_disabled_:{}}),y[f]){var l=y[f],u=y._disabled_[f];u||(y._disabled_[f]=u=[]),u.push(l);var c=u.indexOf(C);c!=-1&&u.splice(c,1)}y[f]=C},A.removeDefaultHandler=function(f,C){var y=this._defaultHandlers;if(y){var l=y._disabled_[f];if(y[f]==C)l&&this.setDefaultHandler(f,l.pop());else if(l){var u=l.indexOf(C);u!=-1&&l.splice(u,1)}}},A.on=A.addEventListener=function(f,C,y){this._eventRegistry=this._eventRegistry||{};var l=this._eventRegistry[f];return l||(l=this._eventRegistry[f]=[]),l.indexOf(C)==-1&&l[y?"unshift":"push"](C),C},A.off=A.removeListener=A.removeEventListener=function(f,C){this._eventRegistry=this._eventRegistry||{};var y=this._eventRegistry[f];if(y){var l=y.indexOf(C);l!==-1&&y.splice(l,1)}},A.removeAllListeners=function(f){f||(this._eventRegistry=this._defaultHandlers=void 0),this._eventRegistry&&(this._eventRegistry[f]=void 0),this._defaultHandlers&&(this._defaultHandlers[f]=void 0)},ee.EventEmitter=A}),ace.define("ace/range",[],function(M,ee,G){"use strict";var A=function(){function i(D,f,C,y){this.start={row:D,column:f},this.end={row:C,column:y}}return i.prototype.isEqual=function(D){return this.start.row===D.start.row&&this.end.row===D.end.row&&this.start.column===D.start.column&&this.end.column===D.end.column},i.prototype.toString=function(){return"Range: ["+this.start.row+"/"+this.start.column+"] -> ["+this.end.row+"/"+this.end.column+"]"},i.prototype.contains=function(D,f){return this.compare(D,f)==0},i.prototype.compareRange=function(D){var f,C=D.end,y=D.start;return f=this.compare(C.row,C.column),f==1?(f=this.compare(y.row,y.column),f==1?2:f==0?1:0):f==-1?-2:(f=this.compare(y.row,y.column),f==-1?-1:f==1?42:0)},i.prototype.comparePoint=function(D){return this.compare(D.row,D.column)},i.prototype.containsRange=function(D){return this.comparePoint(D.start)==0&&this.comparePoint(D.end)==0},i.prototype.intersects=function(D){var f=this.compareRange(D);return f==-1||f==0||f==1},i.prototype.isEnd=function(D,f){return this.end.row==D&&this.end.column==f},i.prototype.isStart=function(D,f){return this.start.row==D&&this.start.column==f},i.prototype.setStart=function(D,f){typeof D=="object"?(this.start.column=D.column,this.start.row=D.row):(this.start.row=D,this.start.column=f)},i.prototype.setEnd=function(D,f){typeof D=="object"?(this.end.column=D.column,this.end.row=D.row):(this.end.row=D,this.end.column=f)},i.prototype.inside=function(D,f){return this.compare(D,f)==0?!(this.isEnd(D,f)||this.isStart(D,f)):!1},i.prototype.insideStart=function(D,f){return this.compare(D,f)==0?!this.isEnd(D,f):!1},i.prototype.insideEnd=function(D,f){return this.compare(D,f)==0?!this.isStart(D,f):!1},i.prototype.compare=function(D,f){return!this.isMultiLine()&&D===this.start.row?f<this.start.column?-1:f>this.end.column?1:0:D<this.start.row?-1:D>this.end.row?1:this.start.row===D?f>=this.start.column?0:-1:this.end.row===D?f<=this.end.column?0:1:0},i.prototype.compareStart=function(D,f){return this.start.row==D&&this.start.column==f?-1:this.compare(D,f)},i.prototype.compareEnd=function(D,f){return this.end.row==D&&this.end.column==f?1:this.compare(D,f)},i.prototype.compareInside=function(D,f){return this.end.row==D&&this.end.column==f?1:this.start.row==D&&this.start.column==f?-1:this.compare(D,f)},i.prototype.clipRows=function(D,f){if(this.end.row>f)var C={row:f+1,column:0};else if(this.end.row<D)var C={row:D,column:0};if(this.start.row>f)var y={row:f+1,column:0};else if(this.start.row<D)var y={row:D,column:0};return i.fromPoints(y||this.start,C||this.end)},i.prototype.extend=function(D,f){var C=this.compare(D,f);if(C==0)return this;if(C==-1)var y={row:D,column:f};else var l={row:D,column:f};return i.fromPoints(y||this.start,l||this.end)},i.prototype.isEmpty=function(){return this.start.row===this.end.row&&this.start.column===this.end.column},i.prototype.isMultiLine=function(){return this.start.row!==this.end.row},i.prototype.clone=function(){return i.fromPoints(this.start,this.end)},i.prototype.collapseRows=function(){return this.end.column==0?new i(this.start.row,0,Math.max(this.start.row,this.end.row-1),0):new i(this.start.row,0,this.end.row,0)},i.prototype.toScreenRange=function(D){var f=D.documentToScreenPosition(this.start),C=D.documentToScreenPosition(this.end);return new i(f.row,f.column,C.row,C.column)},i.prototype.moveBy=function(D,f){this.start.row+=D,this.start.column+=f,this.end.row+=D,this.end.column+=f},i}();A.fromPoints=function(i,D){return new A(i.row,i.column,D.row,D.column)},A.comparePoints=function(i,D){return i.row-D.row||i.column-D.column},ee.Range=A}),ace.define("ace/anchor",[],function(M,ee,G){"use strict";function A(y,l,u){var c=u?y.column<=l.column:y.column<l.column;return y.row<l.row||y.row==l.row&&c}function i(y,l,u){var c=y.action=="insert",S=(c?1:-1)*(y.end.row-y.start.row),P=(c?1:-1)*(y.end.column-y.start.column),H=y.start,Q=c?H:y.end;return A(l,H,u)?{row:l.row,column:l.column}:A(Q,l,!u)?{row:l.row+S,column:l.column+(l.row==Q.row?P:0)}:{row:H.row,column:H.column}}var D=M("./lib/oop"),f=M("./lib/event_emitter").EventEmitter,C=function(){function y(l,u,c){this.$onChange=this.onChange.bind(this),this.attach(l),typeof u!="number"?this.setPosition(u.row,u.column):this.setPosition(u,c)}return y.prototype.getPosition=function(){return this.$clipPositionToDocument(this.row,this.column)},y.prototype.getDocument=function(){return this.document},y.prototype.onChange=function(l){if(!(l.start.row==l.end.row&&l.start.row!=this.row)&&!(l.start.row>this.row)){var u=i(l,{row:this.row,column:this.column},this.$insertRight);this.setPosition(u.row,u.column,!0)}},y.prototype.setPosition=function(l,u,c){var S;if(c?S={row:l,column:u}:S=this.$clipPositionToDocument(l,u),!(this.row==S.row&&this.column==S.column)){var P={row:this.row,column:this.column};this.row=S.row,this.column=S.column,this._signal("change",{old:P,value:S})}},y.prototype.detach=function(){this.document.off("change",this.$onChange)},y.prototype.attach=function(l){this.document=l||this.document,this.document.on("change",this.$onChange)},y.prototype.$clipPositionToDocument=function(l,u){var c={};return l>=this.document.getLength()?(c.row=Math.max(0,this.document.getLength()-1),c.column=this.document.getLine(c.row).length):l<0?(c.row=0,c.column=0):(c.row=l,c.column=Math.min(this.document.getLine(c.row).length,Math.max(0,u))),u<0&&(c.column=0),c},y}();C.prototype.$insertRight=!1,D.implement(C.prototype,f),ee.Anchor=C}),ace.define("ace/document",[],function(M,ee,G){"use strict";var A=M("./lib/oop"),i=M("./apply_delta").applyDelta,D=M("./lib/event_emitter").EventEmitter,f=M("./range").Range,C=M("./anchor").Anchor,y=function(){function l(u){this.$lines=[""],u.length===0?this.$lines=[""]:Array.isArray(u)?this.insertMergedLines({row:0,column:0},u):this.insert({row:0,column:0},u)}return l.prototype.setValue=function(u){var c=this.getLength()-1;this.remove(new f(0,0,c,this.getLine(c).length)),this.insert({row:0,column:0},u||"")},l.prototype.getValue=function(){return this.getAllLines().join(this.getNewLineCharacter())},l.prototype.createAnchor=function(u,c){return new C(this,u,c)},l.prototype.$detectNewLine=function(u){var c=u.match(/^.*?(\r\n|\r|\n)/m);this.$autoNewLine=c?c[1]:`
...
//# sourceMappingURL=vendors-node_modules_iobroker_json-config_build_index_js.c2688222.chunk.js.map