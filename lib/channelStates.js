...
const CHANNEL_STATES = {
    ACCELERATION_SENSOR_CHANNEL: {
        states: {
            ...
            notificationSoundTypeHighToLow: {
                ...
                write: true,
                parameter: 'setNotificationSoundTyp',
            },
    ...
    BLIND_CHANNEL: {
        states: {
            ...
            shutterLevel: { type: 'number', role: 'value', min: 0, max: 100, write: true, parameter: 'shutterlevel' },
            slatsLevel: { type: 'number', role: 'value', min: 0, max: 100, write: true, parameter: 'slatsLevel' },
    ...
    DEVICE_OPERATIONLOCK: {
        states: {
            ...
            lowBat: { type: 'boolean', role: 'indicator.maintenance.lowbat' },
            multicastRoutingEnabled: { type: 'boolean', role: 'indicator' },
            operationLockActive: { type: 'boolean', role: 'indicator', write: true, parameter: 'setOperationLock' },
            profilePeriodLimitReached: { type: 'boolean', role: 'indicator' },
            routerModuleEnabled: { type: 'boolean', role: 'switch', write: true, parameter: 'setRouterModuleEnabled' },
            routerModuleSupported: { type: 'boolean', role: 'indicator' },
            rssiDeviceValue: { type: 'number', role: 'value' },
    ...
    DIMMER_CHANNEL: {
        states: {
            dimLevel: { type: 'number', role: 'level.dimmer', min: 0, max: 100, write: true, parameter: 'setDimLevel' },
            on: { type: 'boolean', role: 'switch', write: true, parameter: 'switchState' },
            profileMode: {
                type: 'string',
                role: 'text',
    ...
    MOTION_DETECTION_CHANNEL: {
        states: {
            ...
            motionBufferActive: { type: 'boolean', role: 'switch', read: false, write: true, parameter: 'switchState' },
    ...
    MULTI_MODE_INPUT_DIMMER_CHANNEL: {
        states: {
            ...
            dimLevel: { type: 'number', role: 'value', min: 0, max: 100, write: true, parameter: 'setDimLevel' },
            multiModeInputMode: {
                type: 'string',
                role: 'text',
                states: {
            ...
            on: { type: 'boolean', role: 'switch', write: true, parameter: 'switchState' },
            powerUpSwitchState: { type: 'string', role: 'state', read: false, write: true },
            profileMode: { type: 'string', role: 'text', states: { AUTOMATIC: 'AUTOMATIC', MANUAL: 'MANUAL' } },
            userDesiredProfileMode: {
                type: 'string',
                role: 'state',
    ...
    NOTIFICATION_LIGHT_CHANNEL: {
        states: {
            dimLevel: { type: 'number', role: 'value', write: true, parameter: 'setRgbDimLevel' },
            on: { type: 'boolean', role: 'indicator', write: true, parameter: 'switchState' },
    ...
    NOTIFICATION_MP3_SOUND_CHANNEL: {
        states: {
            ...
            soundFile: { type: 'string', role: 'text', write: true },
            userDesiredProfileMode: {
                type: 'string',
                role: 'text',
                states: { AUTOMATIC: 'AUTOMATIC', MANUAL: 'MANUAL' },
            ...
            volumeLevel: { type: 'number', role: 'value' },
        },
    },
    ...
    SHUTTER_CHANNEL: {
        states: {
            bottomToTopReferenceTime: { type: 'number', role: 'value.interval' },
            changeOverDelay: { type: 'number', role: 'value.interval', write: true, parameter: 'changeOverDelay' },
            delayCompensationValue: { type: 'number', role: 'value.interval' },
            endpositionAutoDetectionEnabled: { type: 'boolean', role: 'switch', write: true, parameter: 'switchState' },
            previousShutterLevel: { type: 'number', role: 'value' },
            processing: { type: 'boolean', role: 'text' },
            profileMode: { type: 'string', role: 'text', states: { AUTOMATIC: 'AUTOMATIC', MANUAL: 'MANUAL' } },
            selfCalibrationInProgress: { type: 'boolean', role: 'indicator' },
            shutterLevel: { type: 'number', role: 'level', min: 0, max: 100, write: true, parameter: 'shutterlevel' },
            stop: {
                type: 'boolean',
                role: 'button',
                name: 'on',
    ...
    SINGLE_KEY_CHANNEL: {
        states: {
            on: { type: 'boolean', role: 'switch', write: true },
        },
    },
    SMOKE_DETECTOR: {
        states: {
    ...
    UNIVERSAL_LIGHT_CHANNEL: {
        states: {
            ...
            dim2WarmActive: { type: 'boolean', role: 'switch', write: true, parameter: 'switchState' },
            dimLevel: { type: 'number', role: 'level.dimmer', min: 0, max: 100, write: true, parameter: 'setDimLevel' },
            hardwareColorTemperatureColdWhite: { type: 'number', role: 'level.color.temperature' },
            hardwareColorTemperatureWarmWhite: { type: 'number', role: 'level.color.temperature' },
            hue: { type: 'number', role: 'level.color.hue', min: 0, max: 360, write: true, parameter: 'hue' },
            humanCentricLightActive: { type: 'boolean', role: 'switch', write: true, parameter: 'switchState' },
            lampFailure: { type: 'number', role: 'value' },
            lightSceneId: { type: 'number', role: 'value', write: true },
...
module.exports = { CHANNEL_STATES, STATELESS_CHANNELS, DERIVERS, channelStateObjects, channelStateValues };
