...
const CHANNEL_STATES = {
    ...
    BACKLIGHT_CHANNEL: {
        states: {
            controlOnTime: { type: 'number', role: 'value.interval', unit: 's', def: 0, write: true, writeOnly: true },
            controlRampTime: {
                type: 'number',
                role: 'value.interval',
                unit: 's',
    ...
    NOTIFICATION_MP3_SOUND_CHANNEL: {
        states: {
            ...
            volumeLevel: { type: 'number', role: 'value', write: true, parameter: 'setSoundFileVolumeLevel' },
        },
    },
    ...
    SHUTTER_CHANNEL: {
        states: {
            ...
            changeOverDelay: { type: 'number', role: 'value.interval' },
            delayCompensationValue: { type: 'number', role: 'value.interval' },
            endpositionAutoDetectionEnabled: { type: 'boolean', role: 'switch' },
            previousShutterLevel: { type: 'number', role: 'value' },
    ...
    UNIVERSAL_LIGHT_CHANNEL: {
        states: {
            ...
            dim2WarmActive: { type: 'boolean', role: 'switch' },
            dimLevel: { type: 'number', role: 'level.dimmer', min: 0, max: 100, write: true, parameter: 'setDimLevel' },
            ...
            lightSceneId: { type: 'number', role: 'value', write: true, parameter: 'startLightScene' },
